...
public class SuperWeChatDBManager {
    ...
    public synchronized Integer saveMessage(InviteMessage message){
        ...
        if(db.isOpen()){
            ...
            values.put(InviteMessgeDao.COLUMN_NAME_NICK_Name, message.getNickname());
    ...
    synchronized public List<InviteMessage> getMessagesList(){
        ...
        if(db.isOpen()){
            Cursor cursor = db.rawQuery("select * from " + InviteMessgeDao.TABLE_NAME +" ORDER BY "+InviteMessgeDao.COLUMN_NAME_AVATAR_TIME+ " desc",null);
            while(cursor.moveToNext()){
                ...
                String nickname = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_NICK_Name));
